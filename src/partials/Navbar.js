    ...
    return (
        <div className="navbar">
            <div className="flex-1 pl-3">
                <Link to={'/dashboard/home'} className="btn btn-ghost normal-case text-2xl text-purple-800 font-bold">TexoAi</Link>
            </div>
            <div className="flex-1 pl-3">
                ...
                <Link to={'/dashboard/projects'} className=" normal-case  text-xl text-gray-400 font-normal">All Projects</Link>
            </div>
            ...
            <div className="flex-none gap-4">
                <div className="flex-1">
                    ...
                    <a className=" normal-case text-xl font-normal pl-3">Mahfuzul Islam Nabil</a>
                </div>
